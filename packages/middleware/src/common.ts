...
/** Partial v1 payment requirements for middleware configuration. */
export type RelaxedRequirements = Partial<x402PaymentRequirementsV1>;

/** Partial v2 payment requirements for middleware configuration. */
...
/** Result of a v1 settlement attempt. */
