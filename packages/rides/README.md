...
| `fetch`    | `{ (input: RequestInfo or URL, init?: RequestInit or undefined): Promise<Response>; (input: string or Request or URL, init?: RequestInit or undefined): Promise<...>; (input: string or ... 1 more ... or URL, init?: RequestInit or undefined): Promise<...>; } or undefined` | Custom fetch function to wrap. Defaults to globalThis.fetch.     |
